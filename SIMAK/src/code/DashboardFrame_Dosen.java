 ...
 * @author Lenovo
 */
public class DashboardFrame_Dosen extends javax.swing.JFrame {

    /**
     * Creates new form main
     */
    public DashboardFrame_Dosen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        pengabdian_masyarakat = new javax.swing.JLabel();
        penelitian = new javax.swing.JLabel();
        ...
        jPanel1.add(lomba, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 120, 150, 210));

        pengabdian_masyarakat.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pengabdian_masyarakatMouseClicked(evt);
            }
        });
        jPanel1.add(pengabdian_masyarakat, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 430, 140, 210));

        penelitian.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                penelitianMouseClicked(evt);
            }
        });
        jPanel1.add(penelitian, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 430, 150, 220));
        ...
        jPanel1.add(matakuliah, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 120, 140, 210));
        ...
        jPanel1.add(mahasiswa, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 430, 150, 210));
        ...
        profile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/icon-profile.png"))); // NOI18N
        profile.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                profileMouseClicked(evt);
            }
        });
        jPanel1.add(profile, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 510, 70, 80));
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/dashboard_dosen.png"))); // NOI18N
    ...
    private void penelitianMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_penelitianMouseClicked
        // TODO add your handling code here:
        this.setVisible(false);
        new PenelitianFrame().setVisible(true);
    }//GEN-LAST:event_penelitianMouseClicked

    private void pengabdian_masyarakatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pengabdian_masyarakatMouseClicked
        // TODO add your handling code here:
        this.setVisible(false);
        new PengabdianFrame().setVisible(true);
    }//GEN-LAST:event_pengabdian_masyarakatMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashboardFrame_Dosen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel penelitian;
    private javax.swing.JLabel pengabdian_masyarakat;
